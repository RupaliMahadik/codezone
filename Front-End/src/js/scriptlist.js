 ...
 * @param {Object} [data.error_code] - the dataset for query
 * @param {Object} [data.message] - the dataset for query
 */

function ajaxSuccess(data) {

  if (data.error_code) {
    displayError(getErrorMessage(data.error_code));
    return;
  }
 var $table = $('#gen-table');
 var items = [];
...
//  $('#error-message').show();
// displayError("sorry server is down");
displayError(getErrorMessage('server_down'));
}
...
/**
 * This function makes to display error messages 
 
 * @param {string} message - message to user about error
