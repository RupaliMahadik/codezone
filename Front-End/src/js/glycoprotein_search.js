...
$( "#protein" ).autocomplete({
    source: function(request, response) {
        // var queryUrl = getWsUrl("type-ahead") + "?" + getSearchtypeheadData( "protein", request.term);
        ...
        $.ajax({
            type: 'post',
            url: getWsUrl("type-ahead"),
            data: getSearchtypeheadData( "protein_id", request.term),
            dataType: "json",
...
function getProteinSearchPostdata(operation,query_type,organism,mass_min,mass_max,gene_name,pathway_id,relation,glycan_id, type, aa_sequence,glycosylated_aa,glycosylation_evidence)
